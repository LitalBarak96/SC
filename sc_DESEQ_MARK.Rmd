...
```{r}
cts <- all_genes
coldata <- read.csv("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/28.5.23/meta_data.csv", row.names=1)
coldata_not_factorial <-  read.csv("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/28.5.23/meta_data.csv")
data_noTPM <- (cts)
