...
all_genes<-read_excel("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/28.5.23/all_gene_Avg_Elav.xlsx",)
...
```{r}
cts <- all_genes
coldata <- read.csv("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/28.5.23/meta_data_elav.csv", row.names=1)
coldata_not_factorial <-  read.csv("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/28.5.23/meta_data_elav.csv")
data_noTPM <- (cts)
