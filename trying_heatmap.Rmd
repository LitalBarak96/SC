...
#test_scale<-mat+0.001
  ...
  plotname<-paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/30.07.23/new_markers/sc_clustering_markker_of_yulia_added_value.tiff")
 tiff(file=plotname,units="in",height=11,width=11,res=600)

pheatmap(test_scale, scale = "row", cluster_cols = FALSE,cluster_rows  = T,show_rownames = F,fontsize_row = 3, fontsize_col = 8,cutree_cols =8,color=colorRampPalette(c("navy", "white", "red"))(50))
dev.off()
```
...
library(dendextend)
library(svDialogs)
phtmap <- pheatmap(all,cluster_cols=FALSE)
