...
library(Seurat)
library(SeuratDisk)
path_to_fca<-"C:/Users/barakli8/Downloads/s_fca_biohub_head_10x.h5ad"
...
seurat_anndata<-LoadH5Seurat("C:/Users/barakli8/Downloads/s_fca_biohub_head_10x.h5seurat")

pbmc <- seurat_anndata


which(grepl("NPF",rownames(x = pbmc)))
rownames(x = pbmc)[1732]
