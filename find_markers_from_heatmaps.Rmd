...
names_of_npfr<-paste0("NPFR_rep",1:ncol(mat))
...
cts <- mat
coldata <- read.csv("D:/OneDrive - Bar Ilan University/Lital/weekly presentation/3.9.23/meta_data_elav_npfr.csv", row.names=1)
coldata_not_factorial <-  read.csv("D:/OneDrive - Bar Ilan University/Lital/weekly presentation/3.9.23/meta_data_elav_npfr.csv")
data_noTPM <- (cts)
