...
enriched_bulk<-normlized_bulk[(normlized_bulk$tdc2) > 1.5,]

enriched_sc<-normlized_sc[(normlized_sc$Tdc2) > 1.5,]
...
#test_scale<-mat+0.001
  ...
  plotname<-paste0("D:/OneDrive - Bar Ilan University/Lital/weekly presentation/14.8.23/",current_gene,"_up_bulk.tiff")
...
#test_scale<-mat+0.001
  ...
  plotname<-paste0("D:/OneDrive - Bar Ilan University/Lital/weekly presentation/14.8.23/",current_gene,"_up_sc.tiff")
 tiff(file=plotname,units="in",height=11,width=11,res=600)
