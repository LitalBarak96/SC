...
cts <- (read.csv("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/14.05.23/ten_cell_type.csv",sep=",",row.names="GeneSymbol"))
coldata <- read.csv("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/14.05.23/meta_test.csv", row.names=1)
coldata_not_factorial <- read.csv("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/14.05.23/meta_test.csv")
data_noTPM <- (cts)
...
#data_frame_merge <- merge(up, down,
#      by = 'row.names', all = TRUE)
genes <- c(row.names(unq_gene))


mat<-table_counts_normalized[genes, ]
# write.csv(table_counts_normalized,"C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/30.07.23/yulia_data.csv")
#mat <- assay(dds)[genes, ]
#mat<-scale(mat)
...
unq_gene<-final_all %>% distinct(gene, .keep_all=TRUE)


write.csv(unq_gene,"C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/30.07.23/yulia_de_genes.csv")
genes <- c(row.names(unq_genes))
...
#pheatmap(mat_new,  cluster_cols=FALSE,show_rownames=FALSE,cluster_rows=FALSE)
  ...
  plotname<-paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/30.07.23/new_markers/yulia_clustering.tiff")
