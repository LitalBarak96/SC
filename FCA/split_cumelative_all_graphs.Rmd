...
head_FCA_sum<-function(gene_name,y_value,bottom_x_value,top_x_value,FCA,NUMBER_OF_FCA,path_of_photos,to_plot){
  ...
  precnt_name<- paste("norm_",gene_name,sep="")
...
library(ggplot2)
all_gene_csv<-read.csv("C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/30.4.23/all_genes.csv")
...
plotname<-"C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/30.4.23/threshold.tiff"
