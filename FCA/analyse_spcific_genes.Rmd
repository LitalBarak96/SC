...
the_last_to_plot_names<-c()
  ...
  for(i in 2:num_of_genes){
    if(!(Main_gene == list_of_gene_names[i])){
      my_plot_order_names<-c(my_plot_order_names,list_of_gene_names[i])
      my_cols[list_of_gene_names[i]]<-"#E0E0E0"
      print(i)
    }else{
      the_last_to_plot_names<-c(the_last_to_plot_names,list_of_gene_names[i])
      print("here")
...
#my_plot_order_names<-c(my_plot_order_names,the_last_to_plot_names)
   ...
   plotname<-paste0("C:/Users/Lital/OneDrive - Bar Ilan University/Lital/weekly presentation/2.7.23/all_gene_elav/",Main_gene,".tiff")
