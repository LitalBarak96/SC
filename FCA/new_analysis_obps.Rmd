...
markers_clustres_20 <- FindMarkers(object = SERUAT_HEAD, ident.1 =20,only.pos = TRUE,logfc.threshold = 1)

markers_clustres_20<-subset(markers_clustres_20,p_val_adj<0.05)

write.csv(markers_clustres_20,"D:/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/obp_analysis/only_m_f/cluster_num_20.csv")


markers_clustres_21 <- FindMarkers(object = SERUAT_HEAD, ident.1 =21,only.pos = TRUE,logfc.threshold = 1)


markers_clustres_21<-subset(markers_clustres_21,p_val_adj<0.05)

write.csv(markers_clustres_21,"D:/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/obp_analysis/only_m_f/cluster_num_21.csv")


markers_clustres_23 <- FindMarkers(object = SERUAT_HEAD, ident.1 =23,only.pos = TRUE,logfc.threshold = 1)



markers_clustres_23<-subset(markers_clustres_21,p_val_adj<0.05)

write.csv(markers_clustres_23,"D:/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/obp_analysis/only_m_f/cluster_num_23.csv")
