...
n<-names(female_marker)
n[1]<-"others"



  plotname<-paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/obp_analysis/only_m_f/pie_male_neruons.tiff")
 tiff(file=plotname,units="in",height=15,width=15,res=600)

pie(male_marker,labels = n, col=rainbow(length(n)),
   main="Pie Chart of neruons males",cex=2)
