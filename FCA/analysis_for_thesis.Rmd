...
```{r}
all_gene_table<-read.table(file = "C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/best_gene_summary_fb_2023_05.tsv", sep = '\t', header = FALSE, fill = TRUE)

colnames(all_gene_table)<-c("Fb_name","gene","database","explain")



sig_genes<-read.csv("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/final_outline/last_analysis/sig_Crz.csv")
library(dplyr)
