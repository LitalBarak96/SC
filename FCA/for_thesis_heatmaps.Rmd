...
mat<-bulk_data[row.names(bulk_data) %in% cross_genes, ]
  ...
  plotname<-paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/heatmap_bulkdata_sc_genes.tiff")
 tiff(file=plotname,units="in",height=15,width=15,res=600)
...
mat<-mat[apply(mat, 1, function(x) !all(x==0)),]
  ...
  plotname<-paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/heatmap_scdata_bulk_genes.tiff")
 tiff(file=plotname,units="in",height=15,width=15,res=600)
...
sc_genes_splited<-split(sc_genes, sc_genes$from_where)
bulk_gene_splited<-split(bulk_gene, bulk_gene$list_of_name.i.)



for(i in 1:8){
  write.csv(sc_genes_splited[[i]],paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/marker_splited/",str_trim(names(sc_genes_splited[i])),"_sc.csv"))
}

for(i in 1:7){
  write.csv(bulk_gene_splited[[i]],paste0("C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/thesis/marker_splited/",str_trim(names(bulk_gene_splited[i])),"_bulk.csv"))
}
