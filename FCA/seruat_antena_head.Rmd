...
list_of_xlimit<-c(10,5,2)
main_path<-"C:/Users/barakli8\OneDrive - Bar Ilan University/Lital/weekly presentation/11.1.23"
for(m in 1:length(list_of_xlimit)){
for(j in 1: length(list_of_freq)){
par(mfrow = c(3, 5))
for(i in 1:length(list_of_gene)){
...
```{r}
library(spatstat.utils, lib.loc = "/private/common/Software/R/Rlibs")
