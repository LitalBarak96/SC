...
library(Seurat)
plots<-FeaturePlot(SERUAT_HEAD,features = c("percent.NPFR", "percent.NPF"),raster=FALSE,order = T,blend = TRUE,cols =  c("white", "#ff0000", "#00ff00"),pt.size = 2,combine = FALSE,min.cutoff = 0.05,blend.threshold= 0)


plotname<-"C:/Users/lital/OneDrive - Bar Ilan University/Lital/weekly presentation/5.3.23/umap_percen_NPFR_NPF.tiff"
...
CombinePlots(plots[3:4], legend = 'none')
...
SERUAT_HEAD$Tttest<-(SERUAT_HEAD$percent.NPFR > 0.1 && SERUAT_HEAD$percent.NPF > 0.1)
